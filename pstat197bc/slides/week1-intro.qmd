...
subtitle: "PSTAT197B/CMPSC190DE Winter 2025"
author: ""
institute: 'UCSB'
format: 
  revealjs:
    incremental: true
    # footer: 'PSTAT197A/CMPSC190DD Winter 2025'
...
-   1 weekly class meeting, usually Thursdays.
...
-   ***Motivational statement*** due Friday 1/17 11:59pm PST. Take some time to write a paragraph or two in response to the following prompts (Submit via [Google form](https://forms.gle/Bf344damoizvxqow9)):
...
-   ***Team contracts*** due Friday 1/17 11:59pm PST. See [template](https://docs.google.com/document/d/1KsJiRks9BLDTtu7i7vBRYNPGr6ewzLV6R8vJj5-duPg/edit?usp=sharing).
 
    -   Submit via [Google drive](https://drive.google.com/drive/folders/1Tg5SY2lOI-CPPfckSyXpgTBp1LEtyq5T?usp=sharing)
