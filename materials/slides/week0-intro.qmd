...
author: 
  - name: "Laura Baracaldo and Kathleen Coburn"
#  - name: "Kathleen Coburn"
institute: 'UCSB'
format: 
  revealjs:
    incremental: true
...
2.  Please sign in using the attendance reporting form found here:
    ...
    [Attendance reporting form](https://forms.gle/QMn4Nf6czyKU6TPf8)
...
3.  Fill out [capstone project intake form](https://forms.gle/25wu63GKEPUvTW5p6).
...
5.  Prepare a [reading response](https://forms.gle/PMEUV6KD9dCoEAPV9).
